 ...
 */var N=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"addEventListener",o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"removeEventListener",i="string"==typeof t?[t]:t;return i.forEach(function(t){e[r](t,n)}),{cancel:function(){return i.forEach(function(t){return e[o](t,n)})}}},C=void 0!==Array.prototype.indexOf,L="undefined"!=typeof window&&void 0!==window.postMessage;if(!j&&(!C||!L))throw Error("Sorry, the Vimeo Player API is not available in this browser.");var A="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==a?a:"undefined"!=typeof self?self:{};!/*!
 ...
 */var $={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},B=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&w(e,t)}(a,e);var t,n,r,o,i=(t=k(),function(){var e,n=b(a);if(t){var r=b(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return T(e)}(this,e)});/**
...
}})}(r,o)}},r._window.addEventListener("message",r._onMessage),"IFRAME"!==r.element.nodeName){var i=G(e,o);Y(F(i),i,e).then(function(t){var n,o,i=H(t,e);return(// Overwrite element with the new iframe,
...
r.ready().then(function(){U(r,"fullscreenchange",X.isFullscreen)})},X.on("fullscreenchange",this.fullscreenchangeHandler)}return this}return(/**
   ...
   * @return {Promise}
   */m(t,[{key:"callMethod",value:function(e){var t=this,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return new R(function(r,o){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
...
// can’t return here.
// eslint-disable-next-line promise/always-return
return e=O(e,"get"),t.ready().then(function(){q(t,e,{resolve:n,reject:r}),U(t,e)}).catch(r)})}},{key:"set",value:function(e,t){var n=this;return new R(function(r,o){if(e=O(e,"set"),null==t)throw TypeError("There must be a value to set.");// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
...
if(null!==e.getAttribute("data-vimeo-defer"))return;var t=G(e),r=F(t);Y(r,t,e).then(function(t){return H(t,e)}).catch(n)}catch(e){n(e)}})}(),/**
 ...
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
window.VimeoSeoMetadataAppended||(window.VimeoSeoMetadataAppended=!0,window.addEventListener("message",function(t){if(S(t.origin)){var n=W(t.data);if(n&&"ready"===n.event)for(var r=e.querySelectorAll("iframe"),o=0;o<r.length;o++){var i=r[o],a=i.contentWindow===t.source;M(i.src)&&a&&new K(i).callMethod("appendVideoMetadata",window.location.href)}}}))}(),/**
 * Seek to time indicated by vimeo_t query parameter if present in URL
 *
 * @param {HTMLElement} [parent=document] The parent element.
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
if(!window.VimeoCheckedUrlTimeParam){window.VimeoCheckedUrlTimeParam=!0;var t=function(e){"console"in window&&console.error&&console.error("There was an error getting video Id: ".concat(e))};window.addEventListener("message",function(n){if(S(n.origin)){var r=W(n.data);if(r&&"ready"===r.event)for(var o=e.querySelectorAll("iframe"),i=0;i<o.length;i++)!function(){var e=o[i],r=e.contentWindow===n.source;if(M(e.src)&&r){var a=new K(e);a.getVideoId().then(function(e){var t=new RegExp("[?&]vimeo_t_".concat(e,"=([^&#]*)")).exec(window.location.href);if(t&&t[1]){var n=decodeURI(t[1]);a.setCurrentTime(n)}}).catch(t)}}()}})}}()),l("9OeKo");// Отримуємо відеоелемент
const Z=document.getElementById("vimeo-player");// Перевіряємо, чи підтримує браузер локальне сховище
if("undefined"!=typeof Storage){// Встановлюємо обробник події timeupdate, щоб оновлювати час відтворення
Z.addEventListener("timeupdate",_.throttle(function(){// Оновлюємо поточний час відтворення у локальному сховищі
localStorage.setItem("videoplayer-current-time",Z.currentTime)},1e3));// Викликаємо функцію не частіше, ніж раз на секунду
// Перевіряємо, чи є збережений час відтворення
let e=localStorage.getItem("videoplayer-current-time");e&&(Z.currentTime=e)}else alert("Ваш браузер не підтримує локальне сховище.");//# sourceMappingURL=02-video.309b9067.js.map

//# sourceMappingURL=02-video.309b9067.js.map
